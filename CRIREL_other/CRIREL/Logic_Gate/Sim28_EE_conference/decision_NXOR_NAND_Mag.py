...
#                    (4600, 'exc_4'):['pulse',duration,2.8,0],\
                    (4600, 'exc_3'):['pulse',duration,1,0],\
                    (4600, 'exc_4'):['pulse',duration,1,0],\
                    (6100, 'exc_3'):['pulse',duration,1,0],\
                    (6100, 'exc_4'):['pulse',duration,0.7,0],\
                    (7600, 'exc_3'):['pulse',duration,0.7,0],\
                    (7600, 'exc_4'):['pulse',duration,1,0],\
                    (2, 'exc_1'):['ramp',0.7,0],\
                    (2, 'exc_2'):['ramp',0.7,0],\
                    (2, 'inh_1'):['ramp',0.8,0],\
                    (2, 'inh_2'):['ramp',0.8,0]},\
...
plot_FR('MemPot', cols=[3,4,5,6], svf='3456.png')