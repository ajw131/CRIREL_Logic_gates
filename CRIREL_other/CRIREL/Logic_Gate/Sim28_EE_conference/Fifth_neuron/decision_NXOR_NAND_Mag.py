...
exec_pro(ID=4095, trial_t=11100, output_Spike=False, gmean=0, gstd=0,\
         event_dic={(100, 'exc_3'):['pulse',duration,1.1,0],\
                    (100, 'exc_4'):['pulse',duration,1.1,0],\
                    (1600, 'exc_3'):['pulse',duration,1.1,0],\
                    (1600, 'exc_4'):['pulse',duration,0.4,0],\
                    (3100, 'exc_3'):['pulse',duration,0.4,0],\
                    (3100, 'exc_4'):['pulse',duration,1.1,0],\
#                    (4600, 'exc_3'):['pulse',duration,2.8,0],\
#                    (4600, 'exc_4'):['pulse',duration,2.8,0],\
                    (4600, 'exc_3'):['pulse',duration,1.1,0],\
                    (4600, 'exc_4'):['pulse',duration,1.1,0],\
                    (6100, 'exc_3'):['pulse',duration,0.4,0],\
                    (6100, 'exc_4'):['pulse',duration,1.1,0],\
                    (7600, 'exc_3'):['pulse',duration,1.1,0],\
                    (7600, 'exc_4'):['pulse',duration,0.4,0],\
                    (9100, 'exc_3'):['pulse',duration,1.1,0],\
                    (9100, 'exc_4'):['pulse',duration,1.1,0],\
                    (2, 'exc_1'):['ramp',0.7,0],\
                    (2, 'exc_2'):['ramp',0.7,0],\
                    (2, 'inh_1'):['ramp',0.7,0],\
                    (2, 'inh_2'):['ramp',0.7,0],\
...
plot_FR('MemPot', cols=[1,2,6,7], svf='1267M.png')