...
exec_pro(ID=4095, trial_t=7100, output_Spike=False, gmean=0, gstd=0,\
         event_dic={(100, 'exc_3'):['pulse',duration,1.2,0],\
                    (100, 'exc_4'):['pulse',duration,1.2,0],\
                    (2105, 'exc_3'):['pulse',duration,1.2,0],\
                    (2100, 'exc_4'):['pulse',duration,1.2,0],\
                    (4100, 'exc_3'):['pulse',duration,1.2,0],\
                    (4105, 'exc_4'):['pulse',duration,1.2,0],\
                    (2, 'exc_1'):['ramp',1.5,0],\
                    (2, 'exc_2'):['ramp',1.5,0],\
                    (2, 'inh_1'):['ramp',1,0],\
                    (2, 'inh_2'):['ramp',1,0]},\
