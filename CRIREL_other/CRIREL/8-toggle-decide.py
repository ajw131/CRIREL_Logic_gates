...
'''
p =-5 #lowest 1.5 on 95, higest seems unbounded.
#start sweep from -1

dur= 95 #sweep from 75(onset) to as high as you want. Steps in 5 ms
...
exec_pro(ID=3435,output_Spike=False, trial_t=1300, output_MemPot=True, event_dic=ed, MemPot='3-aCPG.dat',\
		output_Frate = False)
