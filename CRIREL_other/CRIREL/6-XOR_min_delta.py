...
d = 2 #.6 is minimum
p= 1.13 #between .99 and 1.13, not effected by delta
exec_pro(ID=4095, trial_t=5500, output_Spike=False, gmean=0, gstd=0,\
         event_dic={(100, 'exc_1'):['pulse',duration,p,0],\
                    (100, 'exc_2'):['pulse',duration,p,0],\
                    (2100+d, 'exc_1'):['pulse',duration,p,0],\
                    (2100, 'exc_2'):['pulse',duration,p,0],\
                    (4100, 'exc_1'):['pulse',duration,p,0],\
                    (4100+d, 'exc_2'):['pulse',duration,p,0],\
                    (2, 'exc_1'):['ramp',eee,0],\
                    (2, 'exc_2'):['ramp',eee,0],\
                    (2, 'inh_1'):['ramp',iii,0],\
                    (2, 'inh_2'):['ramp',iii,0],\
