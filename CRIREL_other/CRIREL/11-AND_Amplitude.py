...
input4=45
duration=1000
bias_current=-.835  #d is related to bias current. larger gap with larger d
eee= -.2
iii= -.50
...
d = 1 #d can go down to .1
p =2. #lol p must be between .99 and 1.01. Prolly need gap junctions
exec_pro(ID=4095, trial_t=5500, output_Spike=False, gmean=0, gstd=0,\
         event_dic={(100, 'exc_1'):['pulse_b',duration,p+eee,0,eee],\
                    (100, 'exc_2'):['pulse_b',duration,p+eee,0,eee],\
                    (2100+d, 'exc_1'):['pulse_b',duration,p+eee,0,eee],\
                    (2100, 'exc_2'):['pulse_b',duration,p+eee,0,eee],\
                    (4100, 'exc_1'):['pulse_b',duration,p+eee,0,eee],\
                    (4100+d, 'exc_2'):['pulse_b',duration,p+eee,0,eee],\
                    (100, 'inh_1'):['pulse_b',duration,p+iii,0,eee],\
                    (100, 'inh_2'):['pulse_b',duration,p+iii,0,eee],\
                    (2100+d, 'inh_1'):['pulse_b',duration,p+iii,0,eee],\
                    (2100, 'inh_2'):['pulse_b',duration,p+iii,0,eee],\
                    (4100, 'inh_1'):['pulse_b',duration,p+iii,0,eee],\
                    (4100+d, 'inh_2'):['pulse_b',duration,p+iii,0,eee],\
                    (2, 'exc_1'):['ramp',eee,0],\
                    (2, 'exc_2'):['ramp',eee,0],\
                    (2, 'inh_1'):['ramp',iii,0],\
                    (2, 'inh_2'):['ramp',iii,0],\
